                        ...
                        <div>
                          ...
                          <div className="pt-2">
                            ...
                            {computeResult && (
                              <div>
                                <p>✅ Compute result</p>
                                <table className="min-w-full divide-x divide-y divide-gray-200 border border-gray-200">
                                  <thead>
                                    <tr>
                                      <th
                                        scope="col"
                                    ...
                                    {Array.from(Array(4).keys()).map(i => (
                                      <tr key={i}>
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-white">
                                          {Number(computeResult["same_response_count_for_r" + i]) * 20}%
                                        </td>
                                      </tr>
                                    ))}
                                    <tr>
                                      ...
                                      <td className="px-6 py-4 whitespace-nowrap text-sm text-white">
                                        {Number(computeResult["same_response_count_for_r4"]) * 20}%
                                      </td>
                                    </tr>
                                  </tbody>
                                </table>
